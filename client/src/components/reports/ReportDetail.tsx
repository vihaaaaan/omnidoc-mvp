    ...
    <div className="bg-white rounded-xl shadow-sm p-6 mt-6 border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Session #{session.id.substring(0, 8)} on {formattedDate}</p>
        </div>
      ...
      {report.json_schema && Object.keys(report.json_schema).length > 0 && (
        <div>
          <h3 className="text-md font-medium text-gray-900 mb-4">Examination Data</h3>
